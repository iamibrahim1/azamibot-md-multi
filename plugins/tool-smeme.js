...
let handler = async (m, { conn, text, usedPrefix, command }) => {
	...
	if (!/image\/(jpe?g|png|webp)/.test(mime)) throw `Tag images / stickers with caption *${usedPrefix + command} top|bottom* or image tags that have been sent`
...
handler.help = ['smeme <text1>|<text2>']
handler.tags = ['tools']
